...
public class TransaksiController {
    ...
    @PutMapping("/update")
    public ResponseEntity<TransaksiResponse> updateTransaksi(@RequestBody TransaksiUpdateRequestDto transaksiUpdateRequestDto) {
        return transaksiService.updateTransaksi(transaksiUpdateRequestDto);
    }
